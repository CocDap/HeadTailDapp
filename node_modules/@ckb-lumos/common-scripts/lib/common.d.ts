...
declare function getLockScriptInfos(): {
 ...
 * @param options
 */
export declare function transfer(txSkeleton: TransactionSkeletonType, fromInfos: FromInfo[], toAddress: Address, amount: bigint, changeAddress?: Address, tipHeader?: Header, { config, useLocktimeCellsFirst, LocktimePoolCellCollector, }?: {
    config?: Config;
    useLocktimeCellsFirst?: boolean;
    LocktimePoolCellCollector?: any;
}): Promise<TransactionSkeletonType>;
export declare function injectCapacity(txSkeleton: TransactionSkeletonType, fromInfos: FromInfo[], amount: bigint, changeAddress?: Address, tipHeader?: Header, { config, useLocktimeCellsFirst, LocktimePoolCellCollector, }?: {
    config?: Config;
    useLocktimeCellsFirst?: boolean;
    LocktimePoolCellCollector?: any;
}): Promise<TransactionSkeletonType>;
export declare function payFee(txSkeleton: TransactionSkeletonType, fromInfos: FromInfo[], amount: bigint, tipHeader?: Header, { config, useLocktimeCellsFirst, }?: {
    config?: Config;
    useLocktimeCellsFirst?: boolean;
}): Promise<TransactionSkeletonType>;
export declare function prepareSigningEntries(txSkeleton: TransactionSkeletonType, { config }?: Options): TransactionSkeletonType;
declare function _commonTransfer(txSkeleton: TransactionSkeletonType, fromInfos: FromInfo[], amount: bigint, minimalChangeCapacity: bigint, { config }?: Options): Promise<{
...
export declare function payFeeByFeeRate(txSkeleton: TransactionSkeletonType, fromInfos: FromInfo[], feeRate: bigint, tipHeader?: Header, { config, useLocktimeCellsFirst, }?: {
    config?: Config;
    useLocktimeCellsFirst?: boolean;
}): Promise<TransactionSkeletonType>;
