 ...
 * @param options
 */
export declare function deposit(txSkeleton: TransactionSkeletonType, fromInfo: FromInfo, toAddress: Address, amount: bigint, { config }?: Options): Promise<TransactionSkeletonType>;
/**
