...
exports.PolyjuiceJsonRpcProvider = void 0;
...
class PolyjuiceJsonRpcProvider extends ethers_1.providers.JsonRpcProvider {
    constructor(polyjuice_config, url, network) {
        super(url, network);
        const abi_items = polyjuice_config.abiItems || [];
        this.abi = new base_1.Abi(abi_items);
        ...
        this.godwoker = new base_1.Godwoker(web3_url, godwoker_option);
    }
    setAbi(abiItems) {
...
exports.PolyjuiceJsonRpcProvider = PolyjuiceJsonRpcProvider;
