        ...
        action: function (options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let module of modules) {
                    ...
                    yield neon_build_1.default(module, this.toolchain, !!options.release);
                }
            });
        }
    },
    ...
    exec() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield spec[command].action.call(this, cliArgs(spec[command].args, { argv }), cliUsage(spec[command].usage));
            }
            catch (e) {
                console.error(style.error(e.message));
                console.error();
