...
import { Builder, BuilderOption } from './builders';
...
export default class PWCore {
     ...
     */
    sendSUDT(sudt: SUDT, address: Address, amount: Amount, createAcp?: boolean, signer?: Signer, options?: BuilderOption): Promise<string>;
}
