(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["PolyjuiceWalletSigner"] = factory();
	else
		root["PolyjuiceWalletSigner"] = factory();
})(this, function() {
...
const properties_1 = __webpack_require__(948);
const address_1 = __webpack_require__(398);
const util_1 = __webpack_require__(711);
const abi_1 = __webpack_require__(65);
const logger_1 = __webpack_require__(322);
...
class PolyjuiceWallet extends ethers_1.Wallet {
    constructor(privateKey, polyjuiceConfig, provider) {
        ...
        this.godwoker = new util_1.Godwoker(web3RpcUrl, godwokerOption);
        this.abi = new abi_1.Abi(abiItems || []);
    }
    signTransaction(transaction) {
        return properties_1.resolveProperties(transaction).then(async (tx) => {
            ...
            const t = {
                ...
                gas: bytes_1.hexlify(tx.gasLimit || 50000),
                gasPrice: bytes_1.hexlify(tx.gasPrice || 0),
            };
...
exports.default = PolyjuiceWallet;
