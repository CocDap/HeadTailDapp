(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["PolyjuiceProviders"] = factory();
	else
		root["PolyjuiceProviders"] = factory();
})(this, function() {
...
const { NormalizeL2Transaction, NormalizeRawL2Transaction, NormalizeCreateAccount, NormalizeWithdrawalRequest, NormalizeRawWithdrawalRequest, } = __webpack_require__(994);
const normalizer = __webpack_require__(994);
...
const godwoken_1 = __webpack_require__(492);
const schemas_1 = __webpack_require__(626);
const normalizer_1 = __webpack_require__(994);
const ckb_js_toolkit_1 = __webpack_require__(683);
...
const ethers_1 = __webpack_require__(879);
const bytes_1 = __webpack_require__(103);
const bignumber_1 = __webpack_require__(446);
const abi_1 = __webpack_require__(65);
const util_1 = __webpack_require__(711);
class PolyjuiceJsonRpcProvider extends ethers_1.providers.JsonRpcProvider {
    constructor(godwoker_option, abi_items = [], url, network) {
        super(url, network);
        this.abi = new abi_1.Abi(abi_items);
        const web3_url = typeof url === "string" ? url : url.url;
        this.godwoker = new util_1.Godwoker(web3_url, godwoker_option);
    }
    async sendTransaction(signedTransaction) {
        ...
        try {
            ...
            const fake_tx = {
                ...
                from: "0x",
                nonce: 0,
                gasLimit: bignumber_1.BigNumber.from("0x00"),
                gasPrice: bignumber_1.BigNumber.from("0x00"),
                data: "0x00",
                value: bignumber_1.BigNumber.from("0x00"),
                chainId: 3,
            };
...
__webpack_unused_export__ = PolyjuiceJsonRpcProvider;
exports.default = { PolyjuiceJsonRpcProvider };
